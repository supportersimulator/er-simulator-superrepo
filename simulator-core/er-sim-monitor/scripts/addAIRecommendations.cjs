...
/**
 * Add AI Recommendations functionality to field selector
 * - Adds "Get AI Recommendations" button
 * - Calls existing getRecommendedFields() function
 * - Displays results in RECOMMENDED section
 * - Updates live log with progress
 */
...
async function deploy() {
  try {
    ...
    console.log('🔧 Adding AI Recommendations to field selector...\n');
...
`;
    ...
    console.log('═══════════════════════════════════════════════════════════════');
    console.log('🤖 AI RECOMMENDATIONS ADDED TO FIELD SELECTOR');
    console.log('═══════════════════════════════════════════════════════════════\n');
    console.log('New features:');
    console.log('✅ "Get AI Recommendations" button in RECOMMENDED section');
    console.log('✅ Calls existing getRecommendedFields() function with GPT-4');
    console.log('✅ Displays recommended fields with rationale');
    console.log('✅ Orange highlighted recommendation boxes');
    console.log('✅ Live log shows AI request progress');
    console.log('✅ Can refresh recommendations with updated selection\n');
    console.log('How to use:');
    console.log('1. Open field selector');
    console.log('2. Click "🤖 Get AI Recommendations" button');
    console.log('3. Wait ~10-15 seconds for GPT-4 analysis');
    console.log('4. See recommended fields with AI rationale');
    console.log('5. Check boxes to add recommendations to your selection');
    console.log('6. Save when done\n');
    console.log('═══════════════════════════════════════════════════════════════\n');
