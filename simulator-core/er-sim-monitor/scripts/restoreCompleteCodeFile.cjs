...
/**
 * RESTORE COMPLETE Code.gs from backup + add cache test
 * This restores ALL the tools + adds the TEST-only cache test
 */
...
async function restoreComplete() {
  console.log('\n🔧 RESTORING COMPLETE Code.gs from backup\n');
  console.log('═══════════════════════════════════════════════════════════════\n');
  ...
  try {
    ...
    console.log(`✅ Loaded backup: ${Math.round(code.length / 1024)} KB\n`);

    // Add cache test function at the end
    console.log('📝 Adding cache test function to backup...\n');
...
function runCacheTestWithLogs() {
  ...
  ui.createMenu('TEST Tools')
    ...
    // Deploy
    console.log('🚀 Deploying COMPLETE Code.gs to TEST...\n');
    ...
    console.log('═══════════════════════════════════════════════════════════════');
    console.log('✅ COMPLETE Code.gs RESTORED!\n');
    console.log('📋 ALL MENUS RESTORED:\n');
    console.log('   • 🧠 Sim Builder (all original tools)');
    console.log('   • ER Simulator (waveform mapping)');
    console.log('   • TEST Tools (cache test)\\n');
