...
function buildCategorizationPrompt(cases, validSymptoms, validSystems) {
  ...
  prompt += 'INSTRUCTIONS:\n';
  prompt += '1. For each case, select ONE symptom code from the valid list above\n';
  prompt += '2. For each case, select ONE system category from the valid list above\n';
  prompt += '3. Provide the full name/description for the symptom\n';
  prompt += '4. Provide brief reasoning for your categorization\n\n';
