/**
 * Batch Processing Sidebar Feature - Complete
 *
 * Everything for batch/single/set rows processing sidebar:
 * - Complete sidebar HTML with all controls
 * - Start/stop/refresh button handlers
 * - Progress tracking and logging
 * - API key management
 * - Sheet header caching
 *
 * Common Utility Goal: Adjust all batch processing bar features
 *
 * External Dependencies:
 * - Core_Processing_Engine.gs (for processOneInputRow_)
 *
 * Generated: 2025-11-04T18:48:41.633Z
