...
function runUltimateCategorization(mode, specificInput) {
  ...
  addUltimateCategorizationLog('═══════════════════════════════════════════════════════════');
  addUltimateCategorizationLog('📂 Source: Ultimate Categorization Tool (Complete)');
  ...
  try {
    ...
    for (let i = 0; i < cases.length; i += batchSize) {
      ...
      addUltimateCategorizationLog('═══════════════════════════════════════════════════════════');
      addUltimateCategorizationLog('📂 Executing from: Ultimate Categorization Tool (Complete)');
